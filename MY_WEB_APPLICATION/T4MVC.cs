...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class Layouts {
            public const string UrlPath = "~/Content/Layouts";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class Default {
                public const string UrlPath = "~/Content/Layouts/Default";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            ...
            public static class Home {
                public const string UrlPath = "~/Content/Layouts/Home";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                public static readonly string Site_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/Site.min.css") ? Url("Site.min.css") : Url("Site.css");
            }
        ...
        public static partial class Content 
        {
            ...
            public static partial class Layouts 
            {
                public static partial class Default 
                {
                    public static class Assets
                    {
                        public static readonly string Site_css = T4MVCHelpers.ProcessAssetPath("~/Content/Layouts/Default/Site.css");
                    }
                }
                public static partial class Home 
                {
                    public static class Assets
                    {
                        public static readonly string Site_css = T4MVCHelpers.ProcessAssetPath("~/Content/Layouts/Home/Site.css");
                    }
                }
                public static class Assets
                {
